...
#cl.login(qr=True)
cl.login(token="ErYVvpMJWPDczWPPSMM0.9q2iIcfJltjghJCvoSD1Wa.Da03u0viyVrRQFYTKDYCjUIkJMb+5vQ6xJd6ed7JOUY=")#1
cl.loginResult()

ki = LINETCR.LINE() #Zorro
#ki.login(qr=True)
ki.login(token="ErQZUDkT2ezsnWLQjTs1.QLyVrn/7ce0rYYmzu5Bcyq.FVvrK+Z38f78oSWSXCCZYrMcmAaqNKlrqZTHUDjv0lg=")#2
ki.loginResult()

kk = LINETCR.LINE() #Sanji
#kk.login(qr=True)
kk.login(token="EroLaBKCEW1ZNNiqByIe.zieevjMpKYrx8lPQ/O4TxG.e6z3NFyhrikHqD6czpxGuWymwfhUceNa7nfe1USJ8ag=")#3
kk.loginResult()

kc = LINETCR.LINE() #Ussop
#kc.login(qr=True)
kc.login(token="ErE8Y23veaNybyRtFiT0.OKWky3kb60pcfWQ/EMbTGa.x+PI/lqAN1F/J+CNc+CNmsmGwEoIRsJk9UzmN5LffT8=")#4
kc.loginResult()

ks = LINETCR.LINE() #Chooper
#ks.login(qr=True)
ks.login(token="Erq2e3f9p1LYPsFlU9if.r5RawF4wXYQhVUlqKb6mpW.q93AvswLyDVx1WFyhaq/T1jbgNj2c/qxQje852WpebY=")#5
ks.loginResult()

k1 = LINETCR.LINE() #nami
#k1.login(qr=True)
k1.login(token="Er00ozcxOUXZuvbCeRAb.d+8dm1wfnENnVH33/TFNkW.btB5q1iweSj+1ONcsp7LfkL17zOrvoadoENhUec0/6o=")#6
k1.loginResult()

k2 = LINETCR.LINE() #nico robin
#k2.login(qr=True)
k2.login(token="ErADSjqKQkeyAGTM7VWc.kAk9CwLPKKq4oshOZSf8la.ydYdiIPAu4WYQgVp79FXpITkPETr3TFwx2PHIoP5TvE=")#7
k2.loginResult()

k3 = LINETCR.LINE() #
#k3.login(qr=True)
k3.login(token="ErTV0ZUFk5MIBRSGUGK0./2s3MoOflkpNH0r0WetOqa.UVbn2eX2X0lzRY+Kml4RhIofpgXGTZbUzcSh2+Bvd4Q=")#8
k3.loginResult()

k4 = LINETCR.LINE() #
#k4.login(qr=True)
k4.login(token="Er8oCbtbUNvJKiDUgARf.NbF/Fo9xTFqH5km5uqdJtW.cWUMrD3Ncu/KYjTygb/sBC4qBUtxdm+hy9kMh+VTObs=")#9
k4.loginResult()

k5 = LINETCR.LINE() #
#k5.login(qr=True)
k5.login(token="ErxeTwZdaROwUntsMOCb.ItDjsL+frxwoprqw2rlDoW.OWwlMDjaHUSDEbs/5iEV4tCNMrOC5R3lKKsXs3qh3pc=")#10
k5.loginResult()

k6 = LINETCR.LINE() #
#k6.login(qr=True)
k6.login(token="ErhsjkUqHA35GHBbXH5d.HGgncuHcDdzckuAbv/uk3q.TUpsVPZaKwiJKp5AMk7TKvdOGM2ljrQVs7yWG/vYIJA=")#11
k6.loginResult()

k7 = LINETCR.LINE() #
#k7.login(qr=True)
k7.login(token="ErNPZNdkogLBhpMJsRa9.I5rdSKP0GBT4JKWfwneB2q.qCgQ+pKZQnRSt9567I+nE3M2dwYpkE5pHj42mvFCBZQ=")#12
k7.loginResult()

k8 = LINETCR.LINE() #
#k8.login(qr=True)
k8.login(token="ErMAX2HGWHk8iKbt78J8.qwgL7DJ1+YEOyOYnOpSjsa.py/8HvX3LPZKdec4j/b7GlMhmrZDfXCDslBHzaU7IY0=")#13
k8.loginResult()

satpam = LINETCR.LINE() # 
satpam.login(token="ErGi0Z3qALsFdnHNqpad.bZf8ov6OfVotpzQwqiHbBq.Tko5jm2/zWMVoec6d2L73gqV3c+Ek3pEOygLvCvFyVw=")#14
...
admin=["uf50d888821632d32461e37153ac775c0"]#Krisna,kris,13bot
...
Minat? Silahkan PM!
Idline: http://line.me/ti/p/~gerhana_selatan""",
    "lang":"JP",
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            ...
            if op.param2 in admin:
              ...
              random.choice(KAC).sendText(op.param1, "Mau Ngundang Siapa Lur?\nKk Bukan Admin\nJadi Aku Cancel😛")
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["777"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Jinlip"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["999"]: #Semua Bot Ninggalin Group Kecuali Bot Induk
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
      ...
      #-------------Fungsi Chat ----------------
            elif msg.text in ["Woyy","woyy","Woii","woii"]:
